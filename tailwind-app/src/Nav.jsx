...
<nav className="bg-white border-gray-200 dark:bg-gray-900">
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <div className="hidden w-full md:block md:w-auto" id="navbar-default">
      {/* 
  Usamos el método `map` para recorrer cada objeto del arreglo `navigation`. 
  Por cada elemento `e`, generamos un <li> con un enlace (<a>), cuyo href y texto 
  se obtienen de `e.href` y `e.title`. Además, aplicamos estilos condicionales 
  según si `e.available` es true o false.
*/}
