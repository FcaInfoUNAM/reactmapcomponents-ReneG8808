...
function App() {
  ...
  return (
    ...
    <div className="bg-orange-500 p-8 grid grid-cols-4 gap-4">
      <div>
      <Card title="Playera CR7" paragraph="Playera sudada y usada por el bicho" image="https://upload.wikimedia.org/wikipedia/commons/8/8c/Cristiano_Ronaldo_2018.jpg" />
